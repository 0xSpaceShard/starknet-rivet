...
export const STATE_ARCHIVE_CAPACITY_INFO =
  'With state archive capacity set to <strong>full</strong>, Devnet will store full state history. The default mode is <strong>none</strong>, where no old states are stored.';
